...
class ConnectionHandler:
    ...
    async def handle_hello_message(self, msg_json: Dict[str, Any]):
        ...
        logger.info(f"🚀 [PRELOAD] Preload completed, ready for listening")
    ...
    async def process_text(self, text: str, rid: str = None):
        ...
        try:
            ...
            # Check for sleep/wait mode keywords
                ...
                logger.info(f"😴 [SLEEP_MODE] キーワード検出成功、send_sleep_command呼び出し開始")
                # 待機モードコマンドを先に送信
                await self.send_sleep_command()
                logger.info(f"😴 [SLEEP_MODE] send_sleep_command完了、TTS開始")
...
- Search: "john" → List: ["John Smith"] → {{"matched_name": "John Smith"}}"""
    ...
    async def _classify_letter_response_with_ai(self, response: str, rid: str) -> str:
        ...
        try:
            ...
            # 「聞く」系のパターン
            listen_patterns = [
                r'聞く', r'効く', r'きく', r'いく', r'読んで', r'教えて', r'内容は', r'なに', r'何', 
